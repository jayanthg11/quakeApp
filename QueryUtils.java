...
/**
 * Created by Jayanth on 27-08-2017.
 */
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0;i<features.length();i++){
                ...
                String mag=c.getString("mag");
                int date=c.getInt("time");
                EarthQuake earthquakes2=new EarthQuake(mag,name,date);
                earthquakes.add(earthquakes2);
